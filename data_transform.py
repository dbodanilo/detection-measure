...
directory=["features_"+exercices[0]+'\\vid', "features_"+exercices[1]+'\\vid', "features_"+exercices[2]+'\\vid']
all_angles = {}


for index in range(3):
    all_angles[exercices[index]]=[]
    set_angles=[]
    for k in range(8):
        contents = []
    ...
    all_angles[exercices[index]] = set_angles
